...
(function ($) {
  ...
  function openModal() {
    ...
    $("#notification-modal, .ps-notification--modal").hover(
      function (e) {
        $(".ps-notification--modal").stop(true, true).addClass("active");
      },
      function () {
        $(".ps-notification--modal").stop(true, true).removeClass("active");
      }
    );
  }
